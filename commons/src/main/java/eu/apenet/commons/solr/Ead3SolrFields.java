...
public final class Ead3SolrFields {
    ...
    public final static String TITLE_PROPER = "titleProper"; //indexed+stored - 
    ...
    public final static String AI_ID = "aiId"; //indexed+stored - 
    public final static String AI_NAME = "aiName"; //indexed+stored - 
    public final static String REPOSITORY_CODE = "repositoryCode"; //indexed+stored - 
    ...
    public final static String LANGUAGE = "language"; //indexed+stored - 
    public final static String LANG_MATERIAL = "langMaterial"; //stored - 
    public final static String RECORD_ID = "recordId"; //indexed+stored - 
    ...
    public final static String DUPLICATE_UNIT_ID = "duplicateParentId";//stored

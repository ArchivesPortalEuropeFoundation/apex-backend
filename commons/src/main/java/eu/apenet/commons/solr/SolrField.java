...
public enum SolrField {
    TITLE(Ead3SolrFields.TITLE_PROPER), SCOPECONTENT(Ead3SolrFields.SCOPE_CONTENT), ALTERDATE(Ead3SolrFields.ALTERNATE_UNIT_DATE), OTHER(Ead3SolrFields.OTHER), UNITID(Ead3SolrFields.UNIT_ID), OTHERUNITID(
            Ead3SolrFields.OTHER_UNIT_ID),

 ...
 */
public enum XmlType {
    EAD_FA(0, "Finding Aid", FindingAid.class),
    EAD_HG(1, "Holdings Guide", HoldingsGuide.class),
    EAC_CPF(2, "EAC-CPF", null),
    EAD_SG(3, "Source Guide", SourceGuide.class);

    private int identifier;
    private String name;
    private Class<? extends Ead> clazz;

    XmlType(int identifier, String name, Class<? extends Ead> clazz){

...
<xsl:import href="contact.xsl"/>
	...
	<xd:doc type="stylesheet">
		...
		<xd:detail>
			...
			<li><b>ACCESS AND SERVICE INFORMATION</b>:
				<ul><br/>
					<li>Opening hours.</li>
					<li>Closing dates.</li>
					...
					<li>Searchroom contact: (Only "see more").</li>
						<ul><li>E-mail address.</li><li>Webpage.</li><li>Telephone.</li></ul>
			...
			<li><b>ARCHIVES AND HOLDINGS DESCRIPTION</b>:
				<ul><br/>
...
<xd:doc type="import">
 	<xd:short>Import the XML: <a href="commonsEag.xsl.xd.html"><code>commonsEag.xml</code></a>, <a href="contact.xsl.xd.html"><code>contact.xsl</code></a>, <a href="archivesHolding.xsl.xd.html"><code>archivesHolding.xml</code></a>, <a href="accessService.xsl.xd.html"><code>accessService.xml</code></a> and <a href="otherInformation.xsl.xd.html"><code>otherInformation.xml</code></a>.
 	</xd:short>
	<xd:detail>

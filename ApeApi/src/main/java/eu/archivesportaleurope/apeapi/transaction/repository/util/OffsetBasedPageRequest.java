...
public class OffsetBasedPageRequest implements Pageable, Serializable {
     ...
     * @param offset zero-based offset.
     * @param limit the size of the elements to be returned.
     * @param direction the direction of the {@link Sort} to be specified, can
     * be {@literal null}.
     * @param properties the properties to sort by, must not be {@literal null}
     * or empty.
     */
     ...
     * applied.
     *
     * @param offset zero-based offset/startIndex
     * @param limit the size of the elements to be returned.
     */

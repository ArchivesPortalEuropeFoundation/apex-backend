...
<body>
	...
	<div id="eadDisplayPortlet">
		<dashboard:ead type="cdetails" xml="${c.xml}" secondDisplayUrl="${pageContext.request.contextPath}/preview.action?xmlTypeId=0&aiId=${c.eadContent.ead.aiId}" aiId="${c.eadContent.ead.aiId}" />

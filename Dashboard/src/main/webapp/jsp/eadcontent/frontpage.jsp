...
<c:otherwise>
<c:set var="printUrl" value="${pageContext.request.contextPath}/displayEadFrontPage.action?fileId=${fileId}&xmlTypeId=${xmlTypeId}&print=true"/>
<script>
    $(document).ready(function() {
...
<dashboard:ead type="frontpage" xml="${eadContent.xml}" />
</div>

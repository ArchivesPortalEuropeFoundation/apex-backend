...
<%@ taglib prefix="s" uri="/struts-tags"%>
         ...
         <div>
                  <ul>				                 
					...
					<li><s:a action="downloadCountriesStatistics"><s:property value="getText('admin.menu.statistics.countries')" /></s:a></li>
					...
					<li><s:a action="manageQueue"><s:property value="getText('admin.queuemanagement.title')" /></s:a> </li>
                 </ul>
         </div>

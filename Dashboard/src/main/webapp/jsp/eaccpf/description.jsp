                                    ...
                                    <tr>
                                        <td style="padding: 0px;"><input type="text" title="YYYY" id="date_1_Year" name="placeTable_<s:property value="#status.index + 1" />_date_1_Year_<s:property value="#status2.index + 1" />" <s:if test='%{#currentDateRow.radioValue1 != "known"}'>disabled="disabled"</s:if> <s:if test="%{#currentDateRow.standardDate1.year != 0}">value="<s:property value="#currentDateRow.standardDate1.year" />"</s:if> size="4" maxlength="4" onchange="validateIsoDates($(this), '<s:property value="getText('eaccpf.commons.error.no.standard.date')" />', '<s:property value="getText('eaccpf.commons.error.no.standard.dateRange')" />');" /></td>
                                            <td style="padding: 0px;">&ndash;</td>
                                                <td style="padding: 0px;"><input type="text" title="MM" id="date_1_Month" name="placeTable_<s:property value="#status.index + 1" />_date_1_Month_<s:property value="#status2.index + 1" />" <s:if test='%{#currentDateRow.radioValue1 != "known"}'>disabled="disabled"</s:if> <s:if test="%{#currentDateRow.standardDate1.month != 0}">value="<s:property value="#currentDateRow.standardDate1.month" />"</s:if> size="2" maxlength="2" onchange="validateIsoDates($(this), '<s:property value="getText('eaccpf.commons.error.no.standard.date')" />', '<s:property value="getText('eaccpf.commons.error.no.standard.dateRange')" />');" /></td>
                                            <td style="padding: 0px;">&ndash;</td>
                                                <td style="padding: 0px;"><input type="text" title="DD" id="date_1_Day" name="placeTable_<s:property value="#status.index + 1" />_date_1_Day_<s:property value="#status2.index + 1" />" <s:if test='%{#currentDateRow.radioValue1 != "known"}'>disabled="disabled"</s:if> <s:if test="%{#currentDateRow.standardDate1.day != 0}">value="<s:property value="#currentDateRow.standardDate1.day" />"</s:if> size="2" maxlength="2" onchange="validateIsoDates($(this), '<s:property value="getText('eaccpf.commons.error.no.standard.date')" />', '<s:property value="getText('eaccpf.commons.error.no.standard.dateRange')" />');" /></td>
                                        </tr>
                                        <tr>
                                    ...
                                    <table style="width: 50%;">
                                        <tr>
                                            <td style="padding: 0px;"><input type="text" title="YYYY" id="date_2_Year" name="placeTable_<s:property value="#status.index + 1" />_date_2_Year_<s:property value="#status2.index + 1" />" <s:if test='%{#currentDateRow.radioValue2 != "known"}'>disabled="disabled"</s:if> <s:if test="%{#currentDateRow.standardDate2.year != 0}">value="<s:property value="#currentDateRow.standardDate2.year" />"</s:if> size="4" maxlength="4" onchange="validateIsoDates($(this), '<s:property value="getText('eaccpf.commons.error.no.standard.date')" />', '<s:property value="getText('eaccpf.commons.error.no.standard.dateRange')" />');" /></td>
                                                ...
                                                <td style="padding: 0px;">&ndash;</td>
                                                    <td style="padding: 0px;"><input type="text" title="DD" id="date_2_Day" name="placeTable_<s:property value="#status.index + 1" />_date_2_Day_<s:property value="#status2.index + 1" />" <s:if test='%{#currentDateRow.radioValue2 != "known"}'>disabled="disabled"</s:if> <s:if test="%{#currentDateRow.standardDate2.day != 0}">value="<s:property value="#currentDateRow.standardDate2.day" />"</s:if>size="2" maxlength="2" onchange="validateIsoDates($(this), '<s:property value="getText('eaccpf.commons.error.no.standard.date')" />', '<s:property value="getText('eaccpf.commons.error.no.standard.dateRange')" />');" /></td>
                                            </tr>
                                            <tr>
                                                <td style="padding: 0px;">YYYY</td>
                                                <td style="padding: 0px;">&ndash;</td>
                                ...
                                <table style="width: 50%;">
                                    <tr>
                                        <td style="padding: 0px;"><input type="text" title="YYYY" id="date_1_Year" name="functionTable_<s:property value="#status.index + 1" />_date_1_Year_<s:property value="#status2.index + 1" />" <s:if test='%{#currentDateRow.radioValue1 != "known"}'>disabled="disabled"</s:if> <s:if test="%{#currentDateRow.standardDate1.year != 0}">value="<s:property value="#currentDateRow.standardDate1.year" />"</s:if> size="4" maxlength="4" onchange="validateIsoDates($(this), '<s:property value="getText('eaccpf.commons.error.no.standard.date')" />', '<s:property value="getText('eaccpf.commons.error.no.standard.dateRange')" />');" /></td>
                                            <td style="padding: 0px;">&ndash;</td>
                                                <td style="padding: 0px;"><input type="text" title="MM" id="date_1_Month" name="functionTable_<s:property value="#status.index + 1" />_date_1_Month_<s:property value="#status2.index + 1" />" <s:if test='%{#currentDateRow.radioValue1 != "known"}'>disabled="disabled"</s:if> <s:if test="%{#currentDateRow.standardDate1.month != 0}">value="<s:property value="#currentDateRow.standardDate1.month" />"</s:if> size="2" maxlength="2" onchange="validateIsoDates($(this), '<s:property value="getText('eaccpf.commons.error.no.standard.date')" />', '<s:property value="getText('eaccpf.commons.error.no.standard.dateRange')" />');" /></td>
                                            <td style="padding: 0px;">&ndash;</td>
                                                <td style="padding: 0px;"><input type="text" title="DD" id="date_1_Day" name="functionTable_<s:property value="#status.index + 1" />_date_1_Day_<s:property value="#status2.index + 1" />" <s:if test='%{#currentDateRow.radioValue1 != "known"}'>disabled="disabled"</s:if> <s:if test="%{#currentDateRow.standardDate1.day != 0}">value="<s:property value="#currentDateRow.standardDate1.day" />"</s:if> size="2" maxlength="2" onchange="validateIsoDates($(this), '<s:property value="getText('eaccpf.commons.error.no.standard.date')" />', '<s:property value="getText('eaccpf.commons.error.no.standard.dateRange')" />');" /></td>
                                        </tr>
                                        <tr>
                                            <td style="padding: 0px;">YYYY</td>
                                            <td style="padding: 0px;">&ndash;</td>
                                ...
                                <table style="width: 50%;">
                                    <tr>
                                        <td style="padding: 0px;"><input type="text" title="YYYY" id="date_1_Year" name="occupationTable_<s:property value="#status.index + 1" />_date_1_Year_<s:property value="#status2.index + 1" />" <s:if test='%{#currentDateRow.radioValue1 != "known"}'>disabled="disabled"</s:if> <s:if test="%{#currentDateRow.standardDate1.year != 0}">value="<s:property value="#currentDateRow.standardDate1.year" />"</s:if> size="4" maxlength="4" onchange="validateIsoDates($(this), '<s:property value="getText('eaccpf.commons.error.no.standard.date')" />', '<s:property value="getText('eaccpf.commons.error.no.standard.dateRange')" />');" /></td>
                                            <td style="padding: 0px;">&ndash;</td>
                                                <td style="padding: 0px;"><input type="text" title="MM" id="date_1_Month" name="occupationTable_<s:property value="#status.index + 1" />_date_1_Month_<s:property value="#status2.index + 1" />" <s:if test='%{#currentDateRow.radioValue1 != "known"}'>disabled="disabled"</s:if> <s:if test="%{#currentDateRow.standardDate1.month != 0}">value="<s:property value="#currentDateRow.standardDate1.month" />"</s:if> size="2" maxlength="2" onchange="validateIsoDates($(this), '<s:property value="getText('eaccpf.commons.error.no.standard.date')" />', '<s:property value="getText('eaccpf.commons.error.no.standard.dateRange')" />');" /></td>
                                            <td style="padding: 0px;">&ndash;</td>
                                                <td style="padding: 0px;"><input type="text" title="DD" id="date_1_Day" name="occupationTable_<s:property value="#status.index + 1" />_date_1_Day_<s:property value="#status2.index + 1" />" <s:if test='%{#currentDateRow.radioValue1 != "known"}'>disabled="disabled"</s:if> <s:if test="%{#currentDateRow.standardDate1.day != 0}">value="<s:property value="#currentDateRow.standardDate1.day" />"</s:if> size="2" maxlength="2" onchange="validateIsoDates($(this), '<s:property value="getText('eaccpf.commons.error.no.standard.date')" />', '<s:property value="getText('eaccpf.commons.error.no.standard.dateRange')" />');" /></td>
                                        </tr>
                                        <tr>
                                            <td style="padding: 0px;">YYYY</td>
                                            <td style="padding: 0px;">&ndash;</td>

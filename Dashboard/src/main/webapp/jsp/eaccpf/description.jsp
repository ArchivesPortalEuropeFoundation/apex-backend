        ...
        <s:iterator var="current" value="loader.places" status="status">
            <table id="placeTable_<s:property value="#status.index + 1" />" class="tablePadding">
                    ...
                    <s:iterator var="currentDateRow" value="#current.dates" status="status2">
                        <tr id="trDate_text_<s:property value="#status2.index + 1" />">
                            <td>
                                ...
                                <td>
                                    <input type="text" id="date_1" name="placeTable_<s:property value="#status.index + 1" />_date_1_<s:property value="#status2.index + 1" />" value="<s:property value="#currentDateRow.dateContent1" />" <s:if test="%{#currentDateRow.standardDate1.year == 0000}">disabled="disabled" </s:if>onchange="parseDateToISO($(this).attr('value'), $(this).parent().parent().parent().parent().attr('id'), $(this).parent().parent().attr('id'), $(this).attr('id'));"><br />
                                <input type="checkbox" id="date_unknown_1" name="placeTable_<s:property value="#status.index + 1" />_date_unknown_1_<s:property value="#status2.index + 1" />" <s:if test="%{#currentDateRow.standardDate1.year == 0000}">checked="checked" </s:if>onchange="toggleDateTextfields($(this));" /><label for="date_unknown_1"><s:property value="getText('eaccpf.commons.unknown.date')" /></label>
                                </td>
                            <s:if test="#currentDateRow.dateContent2 != null or #currentDateRow.standardDate2 != null">
                                <td><label for="date_2"><s:property value="getText('eaccpf.commons.to.date')" /></label></td>
                                <td>
                                    ...
                                    <input type="checkbox" id="date_unknown_2" name="placeTable_<s:property value="#status.index + 1" />_date_unknown_2_<s:property value="#status2.index + 1" />" <s:if test="%{#currentDateRow.standardDate2.year == 2999}">checked="checked" </s:if>onchange="toggleDateTextfields($(this));" /><label for="date_unknown_2"><s:property value="getText('eaccpf.commons.unknown.date')" /></label>
                                    </td>
                            </s:if>
                            <s:else>
                                <td></td>
                        ...
                        <tr id="trDate_iso_<s:property value="#status2.index + 1" />">
                            <td>
                                <label>
                                    <s:property value="getText('eaccpf.commons.iso.date')" />
                                </label>
                            </td>
                ...
                <tr>
                    ...
                    <td><input type="button" value="<s:property value="getText('eaccpf.commons.add.single.date')" />" id="addPlaceDate" onclick="addDateOrDateRangePlace(this.id, $(this).parent().parent().parent().parent().attr('id'), '<s:property value="getText('eaccpf.commons.date')" />', '<s:property value="getText('eaccpf.commons.from.date')" />', '<s:property value="getText('eaccpf.commons.to.date')" />', '<s:property value="getText('eaccpf.commons.unknown.date')" />', '<s:property value="getText('eaccpf.commons.iso.date')" />')" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <input type="button" value="<s:property value="getText('eaccpf.commons.add.range.date')" />" id="addPlaceDateRange" onclick="addDateOrDateRangePlace(this.id, $(this).parent().parent().parent().parent().attr('id'), '<s:property value="getText('eaccpf.commons.date')" />', '<s:property value="getText('eaccpf.commons.from.date')" />', '<s:property value="getText('eaccpf.commons.to.date')" />', '<s:property value="getText('eaccpf.commons.unknown.date')" />', '<s:property value="getText('eaccpf.commons.iso.date')" />')" /></td>
                    ...
                    <s:if test="%{#current.dates.size() > 0}">
                        ...
                        <tr id="trDate_text_<s:property value="#status2.index + 1" />">
                            <td>
                                ...
                                <td>
                                    <input type="text" id="date_1" name="functionTable_<s:property value="#status.index + 1" />_date_1_<s:property value="#status2.index + 1" />" value="<s:property value="#currentDateRow.dateContent1" />" <s:if test="%{#currentDateRow.standardDate1.year == 0000}">disabled="disabled" </s:if>onchange="parseDateToISO($(this).attr('value'), $(this).parent().parent().parent().parent().attr('id'), $(this).parent().parent().attr('id'), $(this).attr('id'));"><br />
                                <input type="checkbox" id="date_unknown_1" name="functionTable_<s:property value="#status.index + 1" />_date_unknown_1_<s:property value="#status2.index + 1" />" <s:if test="%{#currentDateRow.standardDate1.year == 0000}">checked="checked" </s:if>onchange="toggleDateTextfields($(this));" /><label for="date_unknown_1"><s:property value="getText('eaccpf.commons.unknown.date')" /></label>
                                </td>
                            <s:if test="#currentDateRow.dateContent2 != null or #currentDateRow.standardDate2 != null">
                                <td><label for="date_2"><s:property value="getText('eaccpf.commons.to.date')" /></label></td>
                                <td>
                                    ...
                                    <input type="checkbox" id="date_unknown_2" name="functionTable_<s:property value="#status.index + 1" />_date_unknown_2_<s:property value="#status2.index + 1" />" <s:if test="%{#currentDateRow.standardDate2.year == 2999}">checked="checked" </s:if>onchange="toggleDateTextfields($(this));" /><label for="date_unknown_2"><s:property value="getText('eaccpf.commons.unknown.date')" /></label>
                                    </td>
                            </s:if>
                            <s:else>
                                <td></td>
                        ...
                        <tr id="trDate_iso_<s:property value="#status2.index + 1" />">
                            <td><label><s:property value="getText('eaccpf.commons.iso.date')" /></label></td>
                    ...
                    <s:iterator var="currentDateRow" value="#current.dates" status="status2">
                        <tr id="trDate_text_<s:property value="#status2.index + 1" />">
                            <td>
                                ...
                                <td>
                                    <input type="text" id="date_1" name="occupationTable_<s:property value="#status.index + 1" />_date_1_<s:property value="#status2.index + 1" />" value="<s:property value="#currentDateRow.dateContent1" />" <s:if test="%{#currentDateRow.standardDate1.year == 0000}">disabled="disabled" </s:if>onchange="parseDateToISO($(this).attr('value'), $(this).parent().parent().parent().parent().attr('id'), $(this).parent().parent().attr('id'), $(this).attr('id'));"><br />
                                <input type="checkbox" id="date_unknown_1" name="occupationTable_<s:property value="#status.index + 1" />_date_unknown_1_<s:property value="#status2.index + 1" />" <s:if test="%{#currentDateRow.standardDate1.year == 0000}">checked="checked" </s:if>onchange="toggleDateTextfields($(this));" /><label for="date_unknown_1"><s:property value="getText('eaccpf.commons.unknown.date')" /></label>
                                </td>
                            <s:if test="#currentDateRow.dateContent2 != null or #currentDateRow.standardDate2 != null">
                                <td><label for="date_2"><s:property value="getText('eaccpf.commons.to.date')" /></label></td>
                                <td>
                                    ...
                                    <input type="checkbox" id="date_unknown_2" name="occupationTable_<s:property value="#status.index + 1" />_date_unknown_2_<s:property value="#status2.index + 1" />" <s:if test="%{#currentDateRow.standardDate2.year == 2999}">checked="checked" </s:if>onchange="toggleDateTextfields($(this));" /><label for="date_unknown_2"><s:property value="getText('eaccpf.commons.unknown.date')" /></label>
                                    </td>
                            </s:if>
                            <s:else>
                                <td></td>

...
/**
 *  Class is used to manage and store the {@link EAG2012} EAG2012. 
 *  To be able to realize those actions
 */
public class WebFormEAG2012Action extends AbstractInstitutionAction {
	...
	/**
	 * @return {@linkMap<String,String>} languageList to get
	 */
	...
	* @return Map<String,String> PhotographList to get
	...
	/**
	 * @param typeOfInstitutionMap Map<String, String> the typeOfInstitutionMap to set
	 */
	...
	/**
	 * @param continentOfInstitutionMap Map<String, String> the continentOfInstitutionMap to set
	 */
	...
	/**
	 * @param countryOfTheInstitution {@link String} the CountryOfTheInstitution to set
	 */
	...
	/**
	 * @param typeYourRelationMap Map<String, String> the typeYourRelationMap to set
	 */
	...
	/**
	 * @param typetheRelationMap Map<String, String> the typeTheRelationMap to set
	 */
	...
	/**
	 * @param personResponsibleForDescription {@link String} the personResponsibleForDescription to set
	 */
	...
	/**
	 * @param nameOfInstitutionLanguage {@link String} the nameOfInstitutionLanguage to set
	 */
	...
	/**
	 * @param parallelNameOfInstitution {@link String} the parallelNameOfInstitution to set
	 */
	...
	/**
	 * @param parallelNameOfInstitutionLanguage {@link String} the parallelNameOfInstitutionLanguage to set
	 */
	...
	/**
	 * @param repositoridCountryCode {@link String} the repositoridCountryCode to set
	 */
	...
	/**
	 * @param otherRepositorIdValue {@link String} the otherRepositorIdValue to set
	 */
	...
	/**
	 * @param fromDateStandardDate {@link String} the fromDateStandardDate to set
	 */
	 ...
	 * Method for:<br>
	 * - Load XML.
	 * - Create {@link Eag2012} EAG2012 JAXB object and fill eag<Eag>
	 * - Save XML.
	...
	/**
	 * Method for fill default loader values, now only works with main repository.
	 */
...
//		this.loader.setEagRelationrelationEntryDescription(getInstitutionDescriptionOfRelation());
	...
	/**
	 * Method for create List<String> number and loader {@link ControlAbbreviation} control abbreviation.
...
//			JSONUtil util = new JSONUtil();
	 ...
	 * @param countryCode 2 {@link String} letter code for the country (ES, GB, DE ...)
	 ...
	 * @param couAlternativeNameSet {@link String} ountry.getCouAlternativeNames()

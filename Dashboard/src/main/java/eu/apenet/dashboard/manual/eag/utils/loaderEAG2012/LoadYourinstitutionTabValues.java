...
public class LoadYourinstitutionTabValues implements  LoaderEAG2012{
	...
	/**
	 * @param yiNumberOfVisitorsAddress {@link String} the yiNumberOfVisitorsAddress to add
	 */
	...
	/**
	 * @param yiMunicipalityPostalcode {@link String} the yiMunicipalityPostalcode to add
	 */
	...
	/**
	 * @param yiMunicipalityPostalcodeLang {@link String} the yiMunicipalityPostalcodeLang to add
	 */
	...
	/**
	 * @param yiNumberOfPostalAddress {@link String} the yiNumberOfPostalAddress to add
	 */
	...
	/**
	 * @param yiMunicipalityPostalcodePostal {@link String} the yiMunicipalityPostalcodePostal to add
	 */
	...
	/**
	 * @param yiMunicipalityPostalcodePostalLang {@link String} the yiMunicipalityPostalcodePostalLang to add
	 */
	...
	/**
	 * @param yiNumberOfEmailAddress {@link String} the yiNumberOfEmailAddress to add
	 */
	...
	/**
	 * @param yiNumberOfWebpageAddress {@link String} the yiNumberOfWebpageAddress to add
	 */
	...
	/**
	 * @param yiOpening {@link String} the yiOpening to add
	 */
	public void addYiOpening(String yiOpening) {
		this.loader.getYiOpening().add(yiOpening);
	}	
	/**
	...
	/**
	 * @param yiAccessibilityQuestion {@link String} the yiAccessibilityQuestion to add
	 */
	...
	/**
	 * @param yiResourceRelationHref {@link String} the yiResourceRelationHref to add
	 */
	...
	/**
	 * @param yiResourceRelationrelationEntry {@link String} the yiResourceRelationrelationEntry to add
	 */
	...
	/**
	 * @param yiResourceRelationLang {@link String} the yiResourceRelationLang to add
	 */
	...
	/**
	 * Method to load all values of "Your institution" tab in the part of Person/institution responsible for the description
	 */
	...
	/**
	 * Method to load all values of "Your institution" tab in the part of Country code
	 */
	...
	/**
	 * Method to load all values of "Your institution" tab in the part of Identifier of the institution
	 */
	...
	/**
	 * Method to load all values of "Your institution" tab in the part of futher IDS and ID used in APE of the institution
	 */
	...
	/**
	 * Method to load all values of "Your institution" tab in the part of name and parallel of the institution
	 */
	...
	/**
	 * Method to load all values of "Your institution" tab in the part of institution’s holdings guide
	 */
	...
	/**
	 * Method to load all values of "Your institution" tab in the part of Visitor address - Street of the institution
	 */
	...
	/**
	 * Method to load all values of "Your institution" tab in the part of Visitor address - City of the institution
	 */
	...
	/**
	 * Method to load all values of "Your institution" tab in the part of Visitor address - Country of the institution
	 */
	...
	/**
	 * Method to load all values of "Your institution" tab in the part of Visitor adress - Latitude and Longitude of the institution
	 */
	...
	/**
	 * Method to load all values of "Your institution" tab in the part of postal adress - Street of the institution
	 */
	...
	/**
	 * Method to load all values of "Your institution" tab in the part of postal adress - City of the institution
	 */
	...
	/**
	 * Method to load all values of "Your institution" tab in the part of Continente telephone email of institution
	 */
	...
	/**
	 * Method to load all values of "Your institution" tab in the part of webpage of institution
	 */
	...
	/**
	 * Method to load all values of "Your institution" tab in the part of timetable(opening times, closing dates) of institution
	 */
	...
	/**
	 * Method to load all values of "Your institution" tab in the part of Accessible to the public of institution
	 */
	...
	/**
	 * Method to load all values of "Your institution" tab in the part of Facilities for disabled people available of institution
	 */

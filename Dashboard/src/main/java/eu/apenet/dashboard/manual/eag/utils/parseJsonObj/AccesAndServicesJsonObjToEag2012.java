 ...
 *  {@link JSONObject} JSONObject (got from params) in part of acces and services.
 */
public class AccesAndServicesJsonObjToEag2012 extends AbstractJsonObjtoEag2012 implements JsonObjToEag2012{	
	...
	/**
	 * Method that checks if it have to create if the object  and fill it with data the {@link Eag2012} Eag2012 object part of opening times and opening Langs
	 */
	private void OpenigHours()throws JSONException{
		this.log.debug("Method start: \"OpenigHours\"");
		j=0;		
	...
	/**
	 * Method that checks if it have to create if the object  and fill it with data the {@link Eag2012} Eag2012 object part of closing dates 
	 */
	...
	/**
	 * Method that checks if it have to create if the object  and fill it with data the {@link Eag2012} Eag2012 object part of description of directions 
	 */
	...
	/**
	 * Method that checks if it have to create if the object  and fill it with data the {@link Eag2012} Eag2012 object part of  access information and access langs
	 */
	...
	/**
	 * Method that checks if it have to create if the object  and fill it with data the {@link Eag2012} Eag2012 object part of term of use
	 */
	...
	/**
	 * Method that checks if it have to create if the object  and fill it with data the {@link Eag2012} Eag2012 object part of  accessibility
	 */
	...
	/**
	 * Method that checks if it have to create if the object  and fill it with data the {@link Eag2012} Eag2012 object part of  SearchRoomSection
	 */
	...
	/**
	 * Method that checks if it have to create if the object  and fill it with data the {@link Eag2012} Eag2012 object part of  readersticket
	 */
	private void readersticket()throws JSONException{
		this.log.debug("Method start: \"readersticket\"");
		 ...
		 if(accessTable.has("selectASSRPhotographAllowance")){
			 List<String> photographAllowance = eag2012.getPhotographAllowanceValue();photographAllowance = createDataListAcces(photographAllowance,accessTable.getString("selectASSRPhotographAllowance"),i);			
	...
	/**
	 * Method that checks if it have to create if the object  and fill it with data the {@link Eag2012} Eag2012 object part of documents in advance 
	 */
	...
	/**
	 * Method that checks if it have to create if the object  and fill it with data the {@link Eag2012} Eag2012 object part of  researchServices
	 */
	...
	/**
	 * Method that checks if it have to create if the object  and fill it with data the {@link Eag2012} Eag2012 object part of  library
	 */
	...
	/**
	 * Method that checks if it have to create if the object  and fill it with data the {@link Eag2012} Eag2012 object part of  technicalServices
	 */
	...
	/**
	 * Method that checks if it have to create if the object  and fill it with data the {@link Eag2012} Eag2012 object part of  reproductionService
	 */
	...
	/**
	 * Method that checks if it have to create if the object  and fill it with data the {@link Eag2012} Eag2012 object part of  refreshmentArea
	 */
	...
	/**
	 * Method that checks if it have to create if the object  and fill it with data the {@link Eag2012} Eag2012 object part of  exibition
	 */
	...
	/**
	 * Method that checks if it have to create if the object  and fill it with data the {@link Eag2012} Eag2012 object part of  toursAndSessions
	 */
	...
	/**
	 * Method that checks if it have to create if the object  and fill it with data the {@link Eag2012} Eag2012 object part of  otherServices
	 */
	...
	/**
	 * Method that create de jsonobj de {@link Eag2012} Eag2012 for part accessAndServices

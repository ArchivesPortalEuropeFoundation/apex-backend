 ...
 *  {@link JSONObject} JSONObject (got from params) in part of your institution.
 */
public class YourInstitutionJsonObjToEag2012 extends AbstractJsonObjtoEag2012 implements JsonObjToEag2012 {
	 ...
	 * and fill it with data the {@link Eag2012} Eag2012 object part of DataEmail
	...
	/**
	 * Method that checks if it have to create if the object <br> 
	 * and fill it with data the {@link Eag2012} Eag2012 object part of DataOpening
	 * @param target {@link String} the target 
	 * @param key {@link String} the key 	 
	 */
	...
	/**
	 * Method that checks if it have to create if the object<br>  
	 * and fill it with data the {@link Eag2012} Eag2012 object part of DataAccess
	 * @param target {@linkString} the target 
	 * @param key {@link String} the key 	 
	 */
	...
	/**
	 * Method that checks if it have to create if the object<br>  
	 * and fill it with data the {@link Eag2012} Eag2012 object part of DataFacilities
	 * @param target {@link String} the target 
	 * @param key {@link String} the key 	 
	 */
	...
	/**
	 * Method that checks if it have to create if the object<br> 
	 * and fill it with data the {@link Eag2012} Eag2012 object part of visitorAddress
	...
	/**
	 * Method that checks if it have to create if the object<br>  
	 * and fill it with data the {@link Eag2012} Eag2012 object part of ourInstitutionFirstPart
	 */
	...
	/**
	 * Method that checks if it have to create if the object <br>
	 * and fill it with data the {@link Eag2012} Eag2012 object part of visitor address
	 */
	...
	/**
	 * Method that checks if it have to create if the object<br>  
	 * and fill it with data the {@link Eag2012} Eag2012 object part of ourInstitutionLastPart(Telephone,email,web,opening,accessibility)
	 */
	...
	/**
	 * Method That create de JSONObject the {@link Eag2012} Eag2012 for part yourInstitution

				...
				if (CLEVEL.equals(lastElement)) {
					if (noCLevelFound){
						...
						if (indexer != null) {
							...
							indexData.setXml(clevel.getXml());
							indexData.setClId(clevel.getClId());
							indexData.setParentId(parentId);
							indexData.setLeaf(clevel.isLeaf());
							indexData.setUpperLevelUnittitles(upperLevelUnittitles);
							indexData.setFullHierarchy(fullHierarchy);
							indexData.setOrderId(clevel.getOrderId());

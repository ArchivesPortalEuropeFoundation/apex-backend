...
//		}
		...
		try {
			...
			if (xslFileName == null || xslFileName.equals("default.xsl")) {
				...
				TransformationTool.createTransformation(in, tempOutputFile, new File(xslFilePath), null, true, true,
						null, true, null);
				...
				xslMessages = TransformationTool.createTransformation(in, outputfile, xslFile, parameters, true, true,
						null, true, counterCLevelCall);

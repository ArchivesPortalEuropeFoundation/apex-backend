...
public class MetsHttpClient {
	private static final int TIMEOUT = 300000;
	private static final Logger LOGGER = Logger.getLogger(MetsHttpClient.class);
	private CloseableHttpClient httpClient;
	private HttpClientContext context;
	public MetsHttpClient (){
	...
	public MetsHttpClient (String proxyServer, String username, String password){
    	String scheme = "http";
	...
	public CloseableHttpResponse get(String url) throws HarvesterConnectionException{
		...
		httpGet.setHeader("User-Agent", "Archives Portal Europe METS Harvester/" + getVersion());
	...
	public static String getVersion() {
		String version = MetsHttpClient.class.getPackage().getImplementationVersion();

...
public class ApeXMLConstants {
	...
	public static final String METS_RIGHTS_NAMESPACE = "http://www.archivesportaleurope.net/Portal/profiles/rights/";
	public static final String XLINK_PREFIX = "xlink";
	public static final String XSI_PREFIX = "xsi";
	public static final String APE_EAD_LOCATION = "http://schemas.archivesportaleurope.net/profiles/apeEAD.xsd";

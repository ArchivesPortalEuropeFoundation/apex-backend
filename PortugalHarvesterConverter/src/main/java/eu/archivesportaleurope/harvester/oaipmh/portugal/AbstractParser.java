...
public abstract class AbstractParser {
    ...
    protected void writeEAD(XMLStreamWriter xmlWriter) throws XMLStreamException {
        if (xmlWriter != null) {
            ...
            xmlWriter.writeAttribute(XSI, "schemaLocation", "urn:isbn:1-931666-22-9 http://www.archivesportaleurope.net/Portal/profiles/apeEAD.xsd http://www.w3.org/1999/xlink http://www.loc.gov/standards/xlink/xlink.xsd");

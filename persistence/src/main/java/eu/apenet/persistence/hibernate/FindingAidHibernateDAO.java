...
public class FindingAidHibernateDAO extends AbstractHibernateDAO<FindingAid, Integer> implements FindingAidDAO {
	...
	public List<FindingAid> getFindingAidsByHoldingsGuideId(Integer hgId,Integer aiId,Collection<String> fileStates){
		Criteria criteria = createCriteriaForFindingAidsByHoldingsGuide(hgId,aiId,fileStates,null);
	 ...
	 */
	@Override
	public Long countFindingAidsIndexedByHoldingsGuideId(Integer hgId,Integer aiId,List<String> fileStates){
		Criteria criteria = createCriteriaForFindingAidsByHoldingsGuide(hgId,aiId,fileStates,null);
		criteria.setProjection(Projections.count("findingAid.id"));
		return (Long)criteria.uniqueResult();
	}
	
	private Criteria createCriteriaForFindingAidsByHoldingsGuide(Integer hgId,Integer aiId, Collection<String> fileStates,Boolean isLinked) {
		Criteria criteria = getSession().createCriteria(getPersistentClass(),"findingAid");
		criteria = criteria.setResultTransformer(Criteria.DISTINCT_ROOT_ENTITY);

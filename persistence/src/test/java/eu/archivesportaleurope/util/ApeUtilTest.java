...
public class ApeUtilTest {
	...
	private static final String INPUT_ENCODED = "_COLON__ASTERISK__COMP__SLASH__BSLASH__LSQBRKT__RSQBRKT__PLUS__PERCENT__ATCHAR__AMP__DOLLAR__HASH__CFLEX__LRDBRKT__RRDBRKT__EXCLMARK__TILDE__LT__GT__QUOTE__COMMA_";

...
public class CSVStopwordsWriter extends AbstractWriter{

	private static final String SEPARATOR = ";";

	@Override
	protected void addHeaderLine(Writer writer) throws IOException {
		writer.append("Stopword"+ SEPARATOR + "Language" + SEPARATOR + "English translation"+ SEPARATOR + "Source" + "\n");
	...
	protected void addStopwordLine(Writer writer, Stopword stopword) throws IOException {
		if (!stopword.isForbidden()){
			...
			writer.append(SEPARATOR + stopword.getLanguage() + SEPARATOR + stopword.getDescription()+ SEPARATOR + stopword.getValueSource() + "\n");
		}

...
<div id="controlTabContent">
    <table id="controlTable" class="tablePadding">
        ...
        <tr>
            ...
            <td><input type="text" id="responsiblePerson" name="responsiblePerson" value="${loader.controlResponsiblePerson}" /></td>
        </tr>
        <tr>
            <td><label for="responsibleInstitution">Identifier of institution responsible for the description*</label></td>

...
<div id="relationsTabContent">
    ...
    <s:if test="%{loader.cpfRelations.size() > 0}">
        <s:iterator var="current" value="loader.cpfRelations" status="status">
            <table id="cpfRelationsTable_<s:property value="#status.index + 1" />" class="tablePadding">
                ...
                <tr>
                    <td>Description of the relation</td>
                        ...
                        <s:iterator var="currentId" value="#current.agencyCodes" status="status3">
                            <s:if test="%{#status2.index == #status3.index}">
                                <tr id="trCpfRelationRespOrg_<s:property value="#status2.index + 1" />">
                                    ...
                                    <td>Identifier (e.g. ISIL code)</td>
    ...
    <table class="tablePadding">
        <tr>
            <td><input type="button" value="Add further relation" id="addCpfRelationButton" onClick="addCpfRelation('<s:property value="defaultLanguage" />');" /></td>
        </tr>
    </table>
    ...
    <table class="tablePadding">
        <tr>
            <td><input type="button" value="Add further relation" id="addResRelationButton" onClick="addResRelation('<s:property value="defaultLanguage" />');" /></td>
        </tr>
    </table>
    ...
    <table class="tablePadding">
        <tr>
            <td><input type="button" value="Add further relation" id="addFncRelationButton" onClick="addFncRelation('<s:property value="defaultLanguage" />');" /></td>
        </tr>
    </table>
</div>

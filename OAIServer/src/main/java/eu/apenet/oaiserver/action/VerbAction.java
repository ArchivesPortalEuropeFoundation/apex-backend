...
public class VerbAction extends ActionSupport implements ServletRequestAware, ServletResponseAware{
	...
	public String execute(){
		try {
			...
			if (RequestProcessor.VERB_LIST_RECORDS.equals(verb) || RequestProcessor.VERB_IDENTIFY.equals(verb)  || RequestProcessor.VERB_LIST_METADATAFORMATS.equals(verb) || RequestProcessor.VERB_LIST_IDENTIFIERS.equals(verb)){
